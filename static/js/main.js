...
fetch('/category/')
    ...
    .then((category) => {
        const items = category.map((item, index) => {
            ...
            category_names.innerHTML += `<div class="form-check" id="brand">
...
fetch('/brand/')
    ...
    .then((brand) => {
        const items = brand.map((item, index) => {
            brands.innerHTML += `<div class="form-check" id="brand">
            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
                ${item.name}
            </label>
...
fetch('/warranty/')
    ...
    .then((brand) => {
        const items = brand.map((item, index) => {
            warranty.innerHTML += `<div class="form-check" id="brand">
            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
                ${item.name}
            </label>
...
fetch('/seller/')
    ...
    .then((seller) => {
        const items = seller.map((item, index) => {
            seller_name.innerHTML += `<div class="form-check" id="brand">
            <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault">
            <label class="form-check-label" for="flexCheckDefault">
                ${item.name}
            </label>
